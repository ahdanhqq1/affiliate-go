        ...
        <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-md p-4 z-[9999] flex items-center justify-center animate-fade-in" onClick={onClose}>
          ...
          >
            <div className="hidden md:block mb-6 text-center">
              ...
              <p className="text-slate-300">Hak kepemilikan dan batasan penggunaan eksklusif oleh ARDAN.</p>
            </div>
                ...
                <div className="p-6 md:p-8 text-left space-y-8 overflow-y-auto custom-scrollbar bg-white dark:bg-gray-900">
                    ...
                    <div className="flex items-start gap-5 pb-8 border-b border-slate-100 dark:border-white/10">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 dark:text-slate-300 mt-2 text-sm leading-relaxed">Anda diberikan lisensi terbatas oleh ARDAN untuk menggunakan aplikasi ini untuk keperluan pribadi atau bisnis yang sah, sesuai dengan fungsionalitas yang disediakan.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            ...
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mt-2 space-y-1 text-sm pl-1">
                                ...
                                <li>Menjual kembali, menyewakan, atau mendistribusikan ulang aplikasi tanpa izin tertulis dari <strong className="text-slate-900 dark:text-white">ARDAN</strong>.</li>
                            </ul>
                        </div>
                    </div>
